...
## What is Eleven19.Elm.Syntax?

Eleven19.Elm.Syntax is a library that does this specific thing.  

## Why use Eleven19.Elm.Syntax?
...
<div class="row row-cols-1 row-cols-md-2">
  ...
  <div class="col">
    <div class="card h-100">
      ...
      <div class="card-footer text-right   border-top-0">
        <a href="{{siteBaseUrl}}/Api_Reference/Eleven19.Elm.Syntax/Eleven19.Elm.Syntax.html" class="btn btn-primary">Read Api Docs</a>
      </div>
    </div>
  </div>
</div>
